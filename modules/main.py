...
keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com/rockybai327/Moon-txt-uploader.git")],
        ])      
